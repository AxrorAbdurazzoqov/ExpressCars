...
class FetchAllCarsUsecase extends UseCase<List<CarInfoModel>, NoParams> {
  final HomeRepository _repository;

  FetchAllCarsUsecase({required HomeRepository repository}) : _repository = repository;

  @override
  Future<Either<String, List<CarInfoModel>>> call(params) => _repository.fetchAllCars();
}